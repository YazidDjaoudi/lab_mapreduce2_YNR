...
import maxHeight.mapper.TokenizerMapper;
...
public class TokenizerMapperTest {
    ...
    private maxHeight.mapper.TokenizerMapper tokenizerMapper;

    @Before
    public void setup() {
        this.tokenizerMapper = new maxHeight.mapper.TokenizerMapper();
    }

    @Test
    public void testMap() throws IOException, InterruptedException {

        maxHeight.mapper.TokenizerMapper test = new TokenizerMapper();

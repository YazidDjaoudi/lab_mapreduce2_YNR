...
import treesSpecies.mapper.TokenizerMapper;
...
public class TokenizerMapperTest {
    ...
    private treesSpecies.mapper.TokenizerMapper tokenizerMapper;

    @Before
    public void setup() {
        this.tokenizerMapper = new treesSpecies.mapper.TokenizerMapper();
    }

    @Test
    public void testMap() throws IOException, InterruptedException {

        treesSpecies.mapper.TokenizerMapper test = new TokenizerMapper();
        test.map(null, new Text("GEOPOINT;ARRONDISSEMENT;GENRE;ESPECE;FAMILLE;ANNEE PLANTATION;HAUTEUR;CIRCONFERENCE;ADRESSE;NOM COMMUN;VARIETE;OBJECTID;NOM_EV\n" +
                ...
                "(48.8685686134, 2.31331809304);8;Calocedrus;decurrens;Cupressaceae;1854;20.0;195.0;Cours-la-Reine, avenue Franklin-D.-Roosevelt, avenue Matignon, avenue Gabriel;Cèdre à encens;;11;Jardin des Champs Elysées"), this.context);
